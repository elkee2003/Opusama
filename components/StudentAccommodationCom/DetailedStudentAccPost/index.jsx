...
import ReviewStudentAcc from '../ReviewStudentAcc';
  ...
  return (
      <View style={styles.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollContainer}>
          <Link href={`/gallery/studentaccgallery/${post.id}`} asChild>
            <TouchableOpacity>
          ...
          {/* User */}
          <Link href={`/realtor/studentrealtor/studentprofilepage/${realtor.id}`} asChild>
        ...
        <TouchableOpacity style={styles.getinTouchContainer} onPress={()=>router.push(`/realtor/studentrealtor/clientinfo`)}>
...
export default DetailedStudentAccPost;