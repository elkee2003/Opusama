...
const StudentAccPost = ({post}) => {
  ...
  return (
      <View style={styles.container}>
        <Link href={`/search/studentaccommodationsearch/studentaccommodationinfo/${post.id}`} asChild>
          <Pressable>
        ...
        {/* Username */}
        <Link href={`/realtor/studentrealtor/studentrealtorprofilepage/${post.realtorId}`} asChild>
